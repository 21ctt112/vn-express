...
function GiaiTriPage() {
  ...
  const contentItems = [
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/22/HoahauBaoNgoctaiCOP2918JPG-173-1614-7865-1732245882.jpg?w=220&h=132&q=100&dpr=1&fit=crop&s=5o4SrsVkmZjqfcfl7n-9EA",
    ...
    },
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/22/nha-nghien-cuu-nguyen-dinh-tu-6747-9581-1732266636.jpg?w=220&h=132&q=100&dpr=1&fit=crop&s=ZqU5kFY6-dq_cPqgYHPZOw",
    ...
    },
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/22/241121-gma-jolie2-hpmain-16x9-7188-1112-1732256267.jpg?w=220&h=132&q=100&dpr=1&fit=crop&s=gsmgDi3ILWOLEngXQS7mSA",
      altText: "A woman typing on a laptop at a conference",
    ...
    },
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/21/Jordan-Goncalves-18.jpg?w=220&h=132&q=100&dpr=1&fit=crop&s=FOrWfYFOBnomh_MLKx9UEA",
    ...
    },
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/20/tung-duong-1-1732091788-6496-1732091842.jpg?w=220&h=132&q=100&dpr=1&fit=crop&s=WnCFmgDduUrtVHLa7iSgoQ",
      altText: "A model wearing traditional Vietnamese áo dài",
    ...
    },
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/20/sao-tui-mini.jpg?w=220&h=132&q=100&dpr=1&fit=crop&s=FQmMEQsf_qjK0fKx_sl3LA",
      altText: "A model wearing traditional Vietnamese áo dài",
    ...
    },
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/20/operation-undead-1-jpeg-173209-5892-7484-1732091889.jpg?w=220&h=132&q=100&dpr=1&fit=crop&s=5nyv-eLb4rU8hy-XUr-BWQ",
      altText: "A model wearing traditional Vietnamese áo dài",
    ...
    },
    {
      ...
      imageUrl:
        "https://i1-giaitri.vnecdn.net/2024/11/22/image31026736extractword0out-155862-1732260453-1732260828.jpeg?w=220&h=132&q=100&dpr=1&fit=crop&s=uLbv00XujzDdRC69kPVZLA",
      altText: "A model wearing traditional Vietnamese áo dài",
  ...
  const videos = [
    {
      id: 1,
      title: "'Thong dong với Bống': Hồng Nhung sẽ chia cùng người vùng lũ",
      duration: "Đang phát",
    },
    { id: 2, title: "Bảo Thy vui thú trồng trọt", duration: "01:17" },
    {
      id: 3,
      title: "Huỳnh Tú Anh - người mẫu Việt trên sàn diễn quốc tế",
      duration: "00:18",
    },
    {
      id: 4,
      title: "'Thong dong Hà Nội' - Hồng Nhung kể chuyện tuổi thơ",
      duration: "29:53",
    },
    {
      id: 5,
      title: "Kỳ Duyên: 'Tôi hiểu bố mẹ hơn sau nhiều mâu thuẫn'",
      duration: "03:41",
    },
  ];
    ...
    <div className="container">
      <div className="header">
        ...
        <div className="nav">
          ...
          <a
            href="https://vnexpress.net/giai-tri/sach"
            target="_blank"
            rel="noopener noreferrer"
          >
            Sách
          ...
          <a
            href="https://video.vnexpress.net/giai-tri?_gl=1*172t7sy*_gcl_au*MjI1NjAzOTg4LjE3MzIyNjkwODE."
            target="_blank"
            rel="noopener noreferrer"
          >
            Video
          ...
          <a
            href="https://vnexpress.net/giai-tri/nhac"
            target="_blank"
            rel="noopener noreferrer"
          >
            Nhạc
          ...
          <a
            href="https://vnexpress.net/giai-tri/lam-dep"
            target="_blank"
            rel="noopener noreferrer"
          >
            Làm đẹp
      ...
      <div className="main-content">
        <div className="main-article">
          <a
            href="https://vnexpress.net/pham-tuan-ngoc-tu-nguoi-mau-den-a-vuong-the-gioi-4819752.html"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              alt="A banana taped to a wall with a person looking at it"
              src="banner.png"
            />
          </a>
        </div>
        ...
        <div className="side-articles">
          <div className="article">
            <img
              ...
              onClick={() =>
                window.open(
                  "https://vnexpress.net/huynh-hieu-minh-vat-va-vi-giam-cap-toc-15-kg-4819001.html",
                  "_blank"
                )
              }
            ...
            <p>
              Tài tử Trung Quốc Huỳnh Hiểu Minh nói hay bị rụng mình vì lạnh,
              tâm trạng u uất sau khi ép cân để đóng phim.
            </p>
          </div>
          ...
          <div className="article">
            <img
              ...
              onClick={() =>
                window.open(
                  "https://vnexpress.net/thanh-thuy-nu-sinh-chinh-phuc-vuong-mien-miss-international-4815309.html",
                  "_blank"
                )
              }
              style={{ cursor: "pointer" }}
            />
            <h4>
              Hoa hậu Thanh Thủy: 'Tôi không áp lực phải mua nhà, lấy chồng'
            </h4>
            <p className="description">
              Hoa hậu Quốc tế Thanh Thủy nói thích sống tự do, tận hưởng thanh
              xuân, làm gì cũng đóng góp cho cộng đồng thay vì vướng bận yêu
              đương ở tuổi 22.
      ...
      <div className="bottom-articles">
        ...
        <div className="article">
          <img
            ...
            onClick={() =>
              window.open(
                "https://vnexpress.net/tac-gia-104-tuoi-duoc-de-nghi-trao-giai-sach-quoc-gia-4819210.html",
                "_blank"
              )
            }
            style={{ cursor: "pointer" }}
        ...
        <div className="article">
          <img
            ...
            onClick={() =>
              window.open(
                "https://vnexpress.net/nguoi-mau-brazil-me-ao-dai-non-la-4818857.html",
                "_blank"
              )
            }
            style={{ cursor: "pointer" }}
      ...
      <div className="scroll-container">
        ...
        >
          <a
            href="https://vnexpress.net/topic/ly-tu-that-hien-tuong-van-hoa-27823"
            target="_blank"
            rel="noopener noreferrer"
          >
            Lý Tử Thất - hiện tượng văn hóa
          </a>
          <a
            href="https://vnexpress.net/topic/giai-ngoi-sao-cua-nam-2024-27800"
            target="_blank"
            rel="noopener noreferrer"
          >
            Giải Ngôi sao của năm 2024
          </a>
          <a
            href="https://vnexpress.net/topic/tac-dong-cua-tri-tue-nhan-tao-ai-27786"
            target="_blank"
            rel="noopener noreferrer"
          >
            Dự đoán của Trí tuệ nhân tạo AI
          </a>
          <a
            href="https://vnexpress.net/topic/thong-dong-voi-bong-27775"
            target="_blank"
            rel="noopener noreferrer"
          >
            Thong dong với Bống
          ...
          <a
            href="https://vnexpress.net/topic/show-chi-dep-dap-gio-2024-27682"
            target="_blank"
            rel="noopener noreferrer"
          >
            Show "Chị đẹp đạp gió 2024"
          </a>
        </div>
        <button
      ...
      <div className="layout-wrapper">
        ...
        <div className="right-column-container">
          ...
          <div className="left-part">
            <div className="right-column-left-section">
              <div className="navbar">
                ...
                <div className="navbar-links">
                  <a
                    href="https://vnexpress.net/giai-tri/sach/diem-sach"
                    className="navbar-link"
                  >
                    Điểm sách
                  </a>
                  <a
                    href="https://vnexpress.net/giai-tri/sach/lang-van"
                    className="navbar-link"
                  >
                    Làng văn
                  </a>
                  <a
                    href="https://vnexpress.net/giai-tri/sach/tac-gia"
                    className="navbar-link"
                  >
                    Tác giả
                  </a>
              ...
              <a
                href="https://vnexpress.net/nha-van-stephen-king-tu-bo-mang-xa-hoi-x-4816730.html"
              ...
              >
                ...
                <div>
                  ...
                  <div className="right-column-article-content">
                    "Ông hoàng truyện kinh dị" Mỹ Stephen King thông báo ngừng
                    dùng mạng xã hội X vì cho rằng nền tảng này "đầy rẫy thông
                    tin tiêu cực".
                  </div>
                </div>
              </a>
              ...
              <a
                href="https://vnexpress.net/nha-van-trung-trung-dinh-ra-mat-con-thieng-cua-rung-4817284.html"
                className="no-underline"
              >
                <div className="right-column-left-section2">
                  ...
                  <div className="content-section">
                    ...
                    <div className="right-column-article-content2">
                      "Nhà văn Trung Trung Đỉnh ra mắt "Con thiêng của rừng" -
                      truyện lấy cảm hứng từ cuộc đời họa sĩ Xu Man."
                    </div>
                  </div>
                </div>
              </a>
            ...
            {/* Phần bên phải */}
            <a
              href="https://vnexpress.net/su-that-tran-trui-nhung-cu-nga-cua-mike-tyson-4818545.html"
              className="no-underline"
            >
          ...
          <div className="Content2">
            ...
            <div className="left-column2">
              <div className="tab-menu2">
                ...
                <a
                  href="https://vnexpress.net/giai-tri/gioi-sao/trong-nuoc"
                  className="no-underline"
                >
                  <div className="tab-item2">Trong nước</div>
                </a>
                <a
                  href="https://vnexpress.net/giai-tri/gioi-sao/quoc-te"
                  className="no-underline"
                >
              ...
              <a
                href="https://vnexpress.net/y-nhi-dien-mot-ao-giap-4819421.html"
                className="no-underline"
              >
                <div className="news-item2">
                  ...
                  <div className="news-item-content2">
                    ...
                    <p>
                      ...
                      Hoa hậu Ý Nhi mặc kiểu áo giáp mô phỏng đường cong phụ nữ
                      của nhà thiết kế Hà Thanh Việt dự show thời trang.
                    </p>
            ...
            <div className="right-column2">
              <a
                href="https://vnexpress.net/vo-chong-lam-tam-nhu-co-vu-con-gai-bieu-dien-4819488.html"
                className="no-underline"
              >
                <div className="news-list-item2">
                  <h3>Vợ chồng Lâm Tâm Như cổ vũ con gái biểu diễn</h3>
                  <p>
                    Diễn viên Đài Loan Lâm Tâm Như và chồng, tài tử Hoắc Kiến
                    Hoa, gây chú ý khi xem con gái - Amelia - múa hát.
                  </p>
                </div>
              </a>
              <hr className="ngang-3"></hr>
              <a
                href="https://vnexpress.net/thanh-thuy-va-dan-my-nhan-chung-dien-tren-tham-do-4819384.html"
                className="no-underline"
              >
                <div className="news-list-item2">
                  <h3>Thanh Thủy và dàn mỹ nhân chứng diện trên thảm đỏ</h3>
                  <p>
                    TP HCM— Hoa hậu Quốc tế Thanh Thủy cùng các người đẹp Thiên
                    Ân, Nhã Phương tạo dáng khi xem show của nhà thiết kế Hà
                    Thanh Việt.
                  </p>
                </div>
              </a>
              <hr className="ngang-3"></hr>
              <a
                href="https://vnexpress.net/thong-dong-voi-bong-nguon-cam-hung-cua-hong-nhung-4819030.html"
                className="no-underline"
              >
                <div className="news-list-item2">
                  <h3>'Thong dong với Bống': Nguồn cảm hứng của Hồng Nhung</h3>
                  <p>
                    Hồng Nhung cho biết học hỏi nhiều điều từ chuyên gia
                    pilates, nhà thiết kế trong tập 5 "Nguồn cảm hứng" ở series
                    "Thong dong với Bống".
                  </p>
                </div>
              </a>
          ...
          <div className="Content3">
            ...
            <div className="left-column2">
              <div className="tab-menu3">
                ...
                <a
                  href="https://vnexpress.net/giai-tri/phim/thu-vien-phim"
                  className="no-underline"
                >
                ...
                <a
                  href="https://vnexpress.net/giai-tri/phim/sau-man-anh"
                  className="no-underline"
                >
                  <div className="tab-item3">Chuyện màn ảnh</div>
                </a>
              </div>
              <a
                href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/gladiator-ii-753"
                className="no-underline"
              >
                <div className="news-item2">
                  <img
                  ...
                  <div className="news-item-content2">
                    ...
                    <p>
                      Lucius - Paul Mescal đóng - từ nô lệ thành đấu sĩ để báo
                      thù cho người vợ bị quân đội La Mã sát hại, trong phim
                      "Gladiator II".
                    </p>
            ...
            <div className="right-column2">
              <a
                href="https://vnexpress.net/huynh-hieu-minh-vat-va-vi-giam-cap-toc-15-kg-4819001.html"
                className="no-underline"
              >
                <div className="news-list-item2">
                  <h3>Huỳnh Hiểu Minh vật vã vì giảm cấp tốc 15 kg</h3>
                  <p>
                    Tài tử Trung Quốc Huỳnh Hiểu Minh nói hay bị rùng mình vì
                    lạnh, tâm trạng u uất sau khi ép cân để đóng phim.
                  </p>
                </div>
              </a>
              <hr className="ngang-3"></hr>
              <a
                href="https://vnexpress.net/tang-ve-xem-phim-chien-dia-tu-thi-4818349.html"
                className="no-underline"
              >
                <div className="news-list-item2">
                  <h3>Tặng vé xem phim 'Chiến địa tử thi'</h3>
                  <p>
                    VnExpress tặng độc giả bốn cặp vé ra mắt phim Thái "Chiến
                    địa tử thi", có Chanon Santinatornkul đóng chính, vào tối
                    25/11.
                  </p>
                </div>
              </a>
              <hr className="ngang-3"></hr>
              <a
                href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/countdown-paul-vs-tyson-752"
                className="no-underline"
              >
                <div className="news-list-item2">
                  <h3>
                    'Countdown' - trước giờ so găng của Mike Tyson và Jake Paul
                  </h3>
                  <p>
                    Mike Tyson muốn khẳng định vị thế bất bại, còn YouTuber Jake
                    Paul chứng minh mình có thể thành võ sĩ chuyên nghiệp, trong
          ...
          <div className="scroll-container1">
            ...
            <div
              className="scrollable1"
              ref={scrollableRef1}
              onScroll={handleScroll1}
            >
              <a
                href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/love-in-the-big-city-751"
                className="no-underline"
              >
                Love in the Big City
              </a>
              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/cu-li-khong-bao-gio-khoc-750">
                Cu li không bao giờ khóc
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/the-substance-747">
                The Substance
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/the-paradise-of-thorns-748">
                The Paradise of Thons
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/venom-the-last-dance-745">
                Venom: The Last Dance
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/ngay-xua-co-mot-chuyen-tinh-743">
                Ngày xưa có một chuyện tình
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/co-dau-hao-mon-741">
                Cô dâu hào môn
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/return-to-space-739">
                Return to Space
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/cam-733">
                Cám
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/joker-2-736">
                Joker 2
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/ky-uc-lo-to-muon-neo-duong-doi-737">
                Ký ức lô tô: Muôn nẻo đường đời
              </a>

              <a href="https://vnexpress.net/giai-tri/phim/thu-vien-phim/shogun-732">
                Shogun
              </a>
            </div>
            <button
              className={`scroll-button1 prev1 ${
                isLeftDisabled1 ? "disabled" : ""
              }`}
              onClick={scrollLeft1}
            ...
            <button
              className={`scroll-button1 next1 ${
                isRightDisabled1 ? "disabled" : ""
              }`}
      ...
      <div className="container5">
        ...
        <div className="video-section">
          ...
          <div className="main-video">
            ...
            <h3>
              'Thong dong với Bống': Hồng Nhung sẽ chia cùng người vùng lũ
            </h3>
            {/* Danh sách video */}
